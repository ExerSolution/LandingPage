...
validationSchema={
  Yup.object({
    ...
    role:Yup.string().required('Please select a role').oneOf(['Administrator'],'Invalid role')
  })
}
...
<Form className="formy min-h-screen flex flex-col items-center justify-center w-full flex-1 px-4 sm:px-20 text-center">
  <h1 className="flex bg-center text-cyan-700 font-semibold text-3xl pb-10">Register</h1>
    <div className="forms grid gap-6 mb-6 md:grid-cols-2 px-4 sm:px-20">
        ...
        <Field type="text" id="floating_outlined" name="username" className="block px-2.5 pb-2.5 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer focus:border-2" placeholder=" " />
        ...
        <div>
        <div className="relative">
        <Field type="text" id="floating_outlined" name="email" className="block px-2.5 pb-2.5 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer focus:border-2" placeholder=" " />
        ...
        <div>
        <div className="relative">
        <Field type="password" id="floating_outlined" name="password" className="block px-2.5 pb-2.5 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer focus:border-2" placeholder=" " />
        ...
        <div>  
        <div className="relative">
        <Field type="password" id="floating_outlined" name="confirmpassword" className="block px-2.5 pb-2.5 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer focus:border-2" placeholder=" " />
        ...
        <div>
        <div className="relative">
        <Field type="text" id="floating_outlined" name="mobilenumber" className="block px-2.5 pb-2.5 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer focus:border-2" placeholder=" " />
        ...
        <div>
        <div className="relative">
        <Field as="select" id="floating_outlined" name="role" className="block px-2.5 pb-2.5 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer focus:border-2" placeholder=" ">

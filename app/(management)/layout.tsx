      ...
      <body>
        ...
        <QueryClientProvider client={queryClient}>
            ...
            <ToastContainer
              ...
              theme="colored"
            />
            <div className={`md:w-auto ${roboto_slab.className}`}>
...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-50 w-64 h-screen pt-20 transition-transform -translate-x-ful border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar" style={{backgroundColor:'#111827'}}>
   <div className="h-full px-3 pb-4 overflow-y-aut dark:bg-gray-800" style={{backgroundColor:"#111827"}}>
      <ul className="space-y-2 font-medium">
         <li className=" hover:text-gray-800">
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="ms-3 group-hover:text-gray-900 text-white" >Dashboard</span>
            </a>
         </li>
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap group-hover:text-gray-900 text-white">Users</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<aside id="sidebar-wrapper">
  ...
  <ul className="sidebar-nav">
    ...
    <li>
      <a href="#"><i className="fal fa-user"></i>Users</a>
    </li>
  </ul>
</aside>
  ...
  <nav className="navbar navbar-inverse">
    <div className="container-fluid">
      <div className="navbar-header">
        <a href="#" className="navbar-brand" id="sidebar-toggle">  <FontAwesomeIcon icon="coffee" /></a>
      </div>
    </div>
  </nav>
</div>
